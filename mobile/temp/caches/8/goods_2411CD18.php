...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="今麦郎桶红烧牛肉面110g">
            <input type="hidden" name="pics" value="../images/201705/goods_img/286_P_1494288771559.jpg">
            <input type="hidden" name="gid" value="286">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=286">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/286_P_1495134549427.jpg"></a></span></li>
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/286_P_1495216999308.jpg"></a></span></li>
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/286_P_1495134550995.jpg"></a></span></li>
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/286_P_1495134550117.jpg"></a></span></li>
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/286_P_1495134550543.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(286)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">今麦郎桶红烧牛肉面110g</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥3.50元</span><font>价格：￥3.50元</font>                                </dt>
                            </dl>
	...
	<li style=" border-bottom:1px solid #eeeeee">
        <div class="item1">
         ...
         <span class="ui-number">
          ...
          <input type="text" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="0"/>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥3.50元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥3.33元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥3.15元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥2.98元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=286" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <p><br/></p><p><img src="/ueditor/php/upload/image/20170509/1494320907346708.jpg" style="" title="1494320907346708.jpg"/></p><p><img src="/ueditor/php/upload/image/20170509/1494320907546435.jpg" style="" title="1494320907546435.jpg"/></p><p><img src="/ueditor/php/upload/image/20170509/1494320907983410.jpg" style="" title="1494320907983410.jpg"/></p><p><br/></p><p><img src="/ueditor/php/upload/image/20170509/1494320963984640.jpg" title="1494320963984640.jpg" alt="TB2aF7Wd80kpuFjy1XaXXaFkVXa_!!93320225.jpg"/></p><p><br/></p> </div>
        </div>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:286;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(286,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(286)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(286);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(286)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 286;
