...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="立白椰油精华洗衣皂202g">
            <input type="hidden" name="pics" value="../images/201705/goods_img/582_G_1495134503412.jpg">
            <input type="hidden" name="gid" value="582">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=582">
     </form>
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(582)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">立白椰油精华洗衣皂202g</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥4.00元</span><font>价格：￥4.00元</font>                                </dt>
                            </dl>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥4.00元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥3.80元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥3.60元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥3.40元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=582" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <ul class="attributes-list list-paddingleft-2" style="list-style-type: none;"><li><p>产品名称:&nbsp;立白 椰油精华洗衣皂</p></li><li><p>品牌:&nbsp;立白</p></li><li><p>货号:&nbsp;椰油精华洗衣皂</p></li><li><p>是否量贩装:&nbsp;否</p></li><li><p>适用范围:&nbsp;棉麻织物 领口 内衣 婴儿衣</p></li></ul><p><img src="/ueditor/php/upload/image/20170518/1495096890763914.jpg" style="" title="1495096890763914.jpg"/></p><p><img src="/ueditor/php/upload/image/20170518/1495096890604217.jpg" style="" title="1495096890604217.jpg"/></p><p><img src="/ueditor/php/upload/image/20170518/1495096889378861.jpg" style="" title="1495096889378861.jpg"/></p><p><img src="/ueditor/php/upload/image/20170518/1495096890779546.jpg" style="" title="1495096890779546.jpg"/></p><p></p><p><br/></p> </div>
        </div>
    ...
    <h2 style=" border-bottom:1px solid #ddd ">
      ...
      <ul class="xiangq">
                                            <li><p>上架时间：</p><span>2017-05-18</span><li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:582;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(582,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(582)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(582);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(582)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 582;
