...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="金纺衣物护理剂带嘴立袋装900ml">
            <input type="hidden" name="pics" value="../images/201705/goods_img/570_G_1495132737901.jpg">
            <input type="hidden" name="gid" value="570">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=570">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/570_P_1495132901873.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(570)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">金纺衣物护理剂带嘴立袋装900ml</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥9.90元</span><font>价格：￥9.90元</font>                                </dt>
                            </dl>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥9.90元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥9.41元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥8.91元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥8.42元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=570" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <ul class="attributes-list list-paddingleft-2" style="list-style-type: none;"><li><p>产品名称:&nbsp;金纺 衣物护理剂纯净温和</p></li><li><p>容量(ml):&nbsp;900</p></li><li><p>品牌:&nbsp;金纺</p></li><li><p>型号:&nbsp;衣物护理剂纯净温和</p></li><li><p>是否量贩装:&nbsp;否</p></li><li><p>产地:&nbsp;中国</p></li></ul><p><img src="/ueditor/php/upload/image/20170518/1495079253752875.jpg" style="" title="1495079253752875.jpg"/></p><p><img src="/ueditor/php/upload/image/20170518/1495079253352624.jpg" style="" title="1495079253352624.jpg"/></p><p><br/></p> </div>
        </div>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:570;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(570,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(570)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(570);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(570)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 570;
