...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="米老头蛋黄煎饼300g">
            <input type="hidden" name="pics" value="../images/201705/goods_img/476_G_1495132767599.jpg">
            <input type="hidden" name="gid" value="476">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=476">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/476_P_1495132868983.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(476)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">米老头蛋黄煎饼300g</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥11.80元</span><font>价格：￥11.80元</font>                                </dt>
                            </dl>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥11.80元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥11.21元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥10.62元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥10.03元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=476" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:476;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(476,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(476)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(476);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(476)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 476;
