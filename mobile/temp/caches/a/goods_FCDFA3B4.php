...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="米老头多滋纤麦100g巧克力味">
            <input type="hidden" name="pics" value="../images/201705/goods_img/499_P_1494954352557.jpg">
            <input type="hidden" name="gid" value="499">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=499">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/499_P_1495134633897.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(499)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">米老头多滋纤麦100g巧克力味</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥5.90元</span><font>价格：￥5.90元</font>                                </dt>
                            </dl>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥5.90元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥5.61元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥5.31元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥5.02元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=499" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <ul class="attributes-list list-paddingleft-2" style="list-style-type: none;"><li><p>配料表:&nbsp;大米，玉米，起酥油，白砂糖，代可可脂，麦麸，花生，全脂奶粉，可可粉，食用豆粉，荞麦糊精，食用盐等</p></li><li><p>储藏方法:&nbsp;置于阴凉干燥处，避免阳光直射。</p></li><li><p>保质期:&nbsp;270</p></li><li><p>食品添加剂:&nbsp;见包装</p></li><li><p>净含量:&nbsp;100g</p></li><li><p>包装方式:&nbsp;包装</p></li><li><p>品牌:&nbsp;UNCLE POP/米老头</p></li><li><p>系列:&nbsp;夹心棒</p></li></ul><p><img src="/ueditor/php/upload/image/20170517/1494983294831563.jpg" title="1494983294831563.jpg" alt="T2mHEfXqBXXXXXXXXX-2169472812.jpg"/><img src="/ueditor/php/upload/image/20170517/1494983312943727.jpg" title="1494983312943727.jpg" alt="T2i3EbXzBXXXXXXXXX-2169472813.jpg"/></p><p><img src="/ueditor/php/upload/image/20170517/1494983327696325.jpg" style="" title="1494983327696325.jpg"/></p><p><img src="/ueditor/php/upload/image/20170517/1494983328615544.jpg" style="" title="1494983328615544.jpg"/></p><p><br/></p> </div>
        </div>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:499;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(499,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(499)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(499);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(499)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 499;
