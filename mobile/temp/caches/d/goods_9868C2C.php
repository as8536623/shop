...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="统一小当家干吃面30g">
            <input type="hidden" name="pics" value="../images/201705/goods_img/507_P_1494959010789.jpg">
            <input type="hidden" name="gid" value="507">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=507">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201705/goods_img/507_P_1495132882884.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(507)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">统一小当家干吃面30g</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥0.50元</span><font>价格：￥0.50元</font>                                </dt>
                            </dl>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥0.50元</b>
         </p>
             <p>
         <span class="key">铜牌会员：</span>
         <b class="p-price-v">￥0.48元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥0.45元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥0.43元</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=507" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <ul class="attributes-list list-paddingleft-2" style="list-style-type: none;"><li><p>生产许可证编号:&nbsp;QS112707010067</p></li><li><p>产品标准号:&nbsp;LS/T3211GB17400</p></li><li><p>配料表:&nbsp;小麦粉、精炼植物油（含维生素E）、食用盐、</p></li><li><p>储藏方法:&nbsp;宜放置于干燥阴凉处，避免阳光直射</p></li><li><p>保质期:&nbsp;180</p></li><li><p>食品添加剂:&nbsp;有</p></li><li><p>净含量:&nbsp;30g</p></li><li><p>包装方式:&nbsp;包装</p></li><li><p>品牌:&nbsp;统一企业</p></li><li><p>规格:&nbsp;小当家脆脆面香葱味30g</p></li><li><p>是否为有机食品:&nbsp;否</p></li><li><p>方便面包装:&nbsp;袋装</p></li><li><p>商品条形码:&nbsp;6925303744403</p></li><li><p><img src="/ueditor/php/upload/image/20170517/1494987880438160.jpg" style="" title="1494987880438160.jpg"/></p></li><li><p><img src="/ueditor/php/upload/image/20170517/1494987880523581.jpg" style="" title="1494987880523581.jpg"/></p></li><li><p><img src="/ueditor/php/upload/image/20170517/1494987880663729.jpg" style="" title="1494987880663729.jpg"/></p></li><li><p><img src="/ueditor/php/upload/image/20170517/1494987880386162.jpg" style="" title="1494987880386162.jpg"/></p></li><li><p><br/></p></li></ul><p><br/></p> </div>
        </div>
    ...
    <h2 style=" border-bottom:1px solid #ddd ">
      ...
      <ul class="xiangq">
                                            <li><p>上架时间：</p><span>2017-05-17</span><li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:507;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 
        <script language="javascript"> ShowMyComments(507,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(507)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(507);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(507)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 507;
