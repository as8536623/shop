...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="美汁源果粒橙450ml">
            <input type="hidden" name="pics" value=".././images/1409272951415985699.jpg">
            <input type="hidden" name="gid" value="584">
            <input type="hidden" name="url" value="http://www.senke-egou.com/mobile/goods.php?id=584">
     </form>
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(584)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">美汁源果粒橙450ml</h3>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=584" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:584;}554fcae493e564ee0dc75bdf2ebf94ca</div> 
        <script language="javascript"> ShowMyComments(584,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(584)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(584);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(584)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 584;
