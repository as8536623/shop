...
?> 
             <li>
      <?php if ($this->_var['item']['type'] == "favourable"): ?> 优惠活动 
...
?>
     ...
     <?php endif; ?>
       ...
       <?php if ($this->_var['cfg']['use_integral'] || $this->_var['goods']['give_integral'] > 0 || $this->_var['goods']['bonus_money']): ?> 购买此商品可使用积分
        <ul class="youhui_list1" style="margin-top:0px;"> 
      ...
      <?php endif; ?>
         <?php if ($this->_var['goods']['give_integral'] > 0): ?> 购买此商品赠送积分
        ...
        <?php endif; ?>
           <?php if ($this->_var['goods']['bonus_money']): ?> 红包
...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_34791400_1495264086');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_34791400_1495264086']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_34791400_1495264086']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_34791400_1495264086']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_34791400_1495264086']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_34791400_1495264086']['url']; ?>"><?php echo $this->_var['goods_0_34791400_1495264086']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_34791400_1495264086']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
